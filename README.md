...
- Software Engineering Project - Fullstack Bootcamp PowerLearnProject

## Contributors

- **Team Members:** [Caleb Baraka](https://www.linkedin.com/in/caleb-baraka-861532270/), [Yvonne Samwel](https://www.linkedin.com/in/yvonne-samwel-859982187/)
- **Project Duration:** August 2025 - September 20225

## Tools used:
      1) Programming Language and Libraries: Django (Python web framework), Bootstrap, JavaScript, Ajax, Django REST framework.
      2) Database: SQLite
      3) APIs used: MailTrap, Instasend Payment Gateway, , Django PDF library, Django channels for chat, ngrok HTTP, PyPI packages.
...
## Installation Details
      ...
      The credentials that you need to set up are: Mailtrap credentials, Instasend Credentials. 
